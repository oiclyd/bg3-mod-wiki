...
有时候需要让一段正文内容在页面中更醒目，以下是几种方式，可根据场景选择。

### 方式一：引用块（推荐，与现有风格统一）

左侧金色竖线 + 浅底色，适合简短说明和备注。
...
| --- | --- | --- |
| 引用块 | `> 内容` | 简短备注、补充说明 |
| tip 提示框 | `!!! tip` | 答案、解决方案、小贴士 |
| note 提示框 | `!!! note` | 补充信息、注意事项 |
| 带标题提示框 | `!!! tip "标题"` | 需要分类的问答内容 |
| 可折叠 | `??? "标题"` | 长篇内容、剧透、可选阅读 |
